...
public class SqlBaseLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"DESC", "DESCRIBE", "DETERMINISTIC", "DISABLED", "DISTINCT", "DISTRIBUTED", 
			"DROP", "ELSE", "ENABLED", "END", "ENFORCED", "ESCAPE", "EXCEPT", "EXCLUDING", 
			"EXECUTE", "EXISTS", "EXPLAIN", "EXTRACT", "EXTERNAL", "FALSE", "FETCH", 
			...
			"IS", "ISOLATION", "JSON", "JOIN", "KEY", "LANGUAGE", "LAST", "LATERAL", 
			...
			"PREPARE", "PRIMARY", "PRIVILEGES", "PROPERTIES", "RANGE", "READ", "RECURSIVE", 
